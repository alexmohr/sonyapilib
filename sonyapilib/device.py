...
class SonyDevice():
    ...
    def _parse_irccscpd(self):
        response = self._send_http(self.irccscpd_url, method=HttpMethod.GET)
        if response is None:
            return
    ...
    def _parse_dmr(self):
        ...
        if not "av:X_ScalarWebAPI_ServiceType" in response.text:
            return
